...
| 「시연영상_시나리오.md」 | 5분 시연 영상 시나리오 — 맨 위에 녹화 명령 순서 표(17단계), 준비·타임라인·장면별 화면 포인트·나레이션·대체 계획. 장면별 코드 변경은 scripts/demo_recording.py(prepare · scene2 · scene3 · scene4 · reset)가 넣는다 |
